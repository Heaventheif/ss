...
// كل الـ APIs المتاحة — كل واحد يرسم صورة بروفايل المستخدم بأسلوب مختلف.
// الترتيب هنا هو ترتيب "دائرة التشغيل" (round-robin): كل استدعاء لـ canva
...
export default {
  ...
  // Command entry point: pick the next canvas style in rotation, resolve the
  // target UID, fetch the generated image, and send it.
