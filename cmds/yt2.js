...
// Get a downloadable media stream for a resolved YouTube URL.
...
// Resolve a video via the v2 backend endpoint.
...
// Search for videos via the v3 backend endpoint.
...
// Parse a raw backend result into a normalized video object.
function parse(d) {
...
// Download the resolved media and send it to the thread.
...
// Build the numbered search-results list text.
