...
exports.createGetThreadHistoryQuery = createGetThreadHistoryQuery;
const format_1 = __importDefault(format);
const { getAdminTextMessageType } = format_1.default;
function getExtension(originalExtension, filename = "") {
    ...
    return {
        ...
        image: attachment.story_attachment.media == null
            ...
            : attachment.story_attachment.media.animated_image == null &&
                ...
                : (attachment.story_attachment.media.animated_image ||
                    attachment.story_attachment.media.image).uri,
        width: attachment.story_attachment.media == null
            ...
            : attachment.story_attachment.media.animated_image == null &&
                ...
                ? null
                : (attachment.story_attachment.media.animated_image ||
                    attachment.story_attachment.media.image).width,
        height: attachment.story_attachment.media == null
            ...
            : attachment.story_attachment.media.animated_image == null &&
                ...
                ? null
                : (attachment.story_attachment.media.animated_image ||
                    attachment.story_attachment.media.image).height,
        ...
        properties: attachment.story_attachment.properties.reduce((obj, current) => {
...
function formatMessagesGraphQLResponse(data) {
    ...
    return messageThread.messages.nodes.map((message) => {
        switch (message.__typename) {
            case "UserMessage": {
                ...
                if (message.message !== null) {
                    message.message.ranges.forEach((entry) => {
            ...
            case "ThreadImageMessage":
                return {
                    ...
                    snippet: message.snippet,
                    eventData: message.image_with_metadata == null
                        ? {}
                        : {
                            threadImage: {
            ...
            case "ParticipantLeftMessage":
                return {
                    ...
                    snippet: message.snippet,
                    eventData: {
                        participantsRemoved: message.participants_removed.map((participant) => participant.id)
                    },
                    logMessageType: "log:unsubscribe",
                    logMessageData: {
                        leftParticipantFbId: message.participants_removed.map((participant) => participant.id)
                    }
                };
            case "ParticipantsAddedMessage":
                return {
                    ...
                    snippet: message.snippet,
                    eventData: {
                        participantsAdded: message.participants_added.map((participant) => participant.id)
                    },
                    logMessageType: "log:subscribe",
                    logMessageData: {
                        addedParticipants: message.participants_added.map((participant) => participant.id)
                    }
                };
...
function createGetThreadHistoryQuery(deps) {
...
const __export_createGetThreadHistoryQuery = module.exports.createGetThreadHistoryQuery;
export { __export_createGetThreadHistoryQuery as createGetThreadHistoryQuery };
