...
const node_querystring_1 = __importDefault(nodequerystring);
const node_url_1 = __importDefault(nodeurl);
function _formatAttachment(attachment1, attachment2) {
    ...
    switch (type) {
        ...
        case "MessageLocation": {
            ...
            const q0 = node_url_1.default.parse(String(urlAttach)).query;
            const uRaw = node_querystring_1.default.parse(typeof q0 === "string" ? q0 : "").u;
            const uPart = Array.isArray(uRaw) ? uRaw[0] : uRaw;
            const u = uPart != null ? String(uPart) : "";
            const q1 = node_url_1.default.parse(u).query;
            const where1Raw = node_querystring_1.default.parse(typeof q1 === "string" ? q1 : "").where1;
        ...
        case "ExtensibleAttachment":
            return {
                ...
                playableUrl: blob.story_attachment.media == null
                    ? null
        ...
        default:
            throw new Error("unrecognized attach_file of type " +
                type +
                "`" +
...
function formatAttachment(attachments, attachmentIds, attachmentMap, shareMap) {
    ...
    return attachments
        ? attachments.map(function (att, idx) {
            ...
            return _formatAttachment(att, map[attachmentIds[idx]]);
        })
        : [];
}
module.exports = {
